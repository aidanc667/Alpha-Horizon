    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-sans uppercase mb-1" style={{ fontSize: 9.5, letterSpacing: '0.16em', fontWeight: 600, color: '#6366f1' }}>● Backtesting Lab</p>
        ...
        <aside className="w-72 flex-shrink-0 border-r border-gray-100 overflow-y-auto p-4 space-y-4">
              ...
              {[
                ...
                <div key={f.label}>
                  ...
                  <input type="date" value={f.val} min="1986-01-01" max={today}
                    ...
                    className="w-full bg-slate-50 border border-gray-200 rounded-lg px-2 py-1.5 text-xs text-gray-700 focus:outline-none focus:border-[#6366f1] transition-colors" />
                </div>
              ))}
            </div>
                ...
                <div key={f.label}>
                  ...
                  <div className="relative">
                    ...
                    <input type="number" value={f.val} onChange={e => f.set(Number(e.target.value))}
                      className="w-full bg-slate-50 border border-gray-200 rounded-lg pl-6 pr-3 py-1.5 text-xs text-gray-700 focus:outline-none focus:border-[#6366f1] transition-colors" />
                  </div>
                </div>
              ))}
            </div>
          ...
          <section className="bg-white border border-gray-100 rounded-xl shadow-sm p-4 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <button onClick={addTicker} className="p-1 rounded-lg transition-colors" style={{ color: '#6366f1' }}>
                ...
                <div key={i} className="flex gap-1.5 items-end">
                  <div className="flex-1">
                    ...
                    <input type="text" placeholder="SPY" value={a.ticker}
                      ...
                      className="w-full bg-slate-50 border border-gray-200 rounded-lg px-2.5 py-1.5 text-xs font-mono text-gray-700 focus:outline-none focus:border-[#6366f1] uppercase transition-colors" />
                  </div>
                  <div className="w-16">
            ...
            <div className="pt-2 border-t border-gray-200 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => setRebalance(r => !r)}
                  className={clsx('w-9 h-5 rounded-full relative transition-colors', rebalance ? '' : 'bg-gray-200')}
                  style={rebalance ? { background: '#6366f1' } : {}}>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5">
          {!result && !loading && (
            <div className="flex flex-col items-center justify-center h-full min-h-[500px] gap-6 text-center">
              <div className="w-16 h-16 rounded-xl flex items-center justify-center" style={{ background: 'rgba(99,102,241,0.1)' }}>
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center min-h-[500px] gap-4">
              <div className="relative">
                <div className="w-14 h-14 border-2 rounded-full animate-spin" style={{ borderColor: 'rgba(99,102,241,0.2)', borderTopColor: '#6366f1' }} />
              ...
              <div className="bg-white border border-gray-100 rounded-xl shadow-sm p-5">
                <div className="flex items-center justify-between mb-5">
                  ...
                  <div className="flex gap-4">
                    {[
                      ...
                      { label: benchmarkName, color: '#6366f1' },
                ...
                <ResponsiveContainer width="100%" height={280}>
                  <AreaChart data={result.dailyData}>
                    ...
                    <Line type="monotone" dataKey="benchmarkValue" name="benchmarkValue" stroke="#6366f1" strokeWidth={2} dot={false} />
              ...
              <div className="grid grid-cols-2 gap-5">
                ...
                {score !== null && (
                  <div className="bg-white border border-gray-100 rounded-xl shadow-md p-5 flex flex-col items-center gap-4">
                    ...
                    <div
                      className={clsx('w-24 h-24 rounded-full border-4 flex items-center justify-center', score >= 75 ? 'border-emerald-600/30 bg-emerald-600/5' : score >= 50 ? '' : 'border-amber-600/30 bg-amber-600/5')}
                      style={score >= 50 && score < 75 ? { borderColor: 'rgba(99,102,241,0.3)', background: 'rgba(99,102,241,0.05)' } : {}}
                    >
              ...
              {correlationMatrix && correlationMatrix.tickers.length >= 2 && (
                <div className="bg-white border border-gray-100 rounded-xl shadow-sm p-5 space-y-4">
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    ...
                    {[
                      { color: '#6366f1', label: 'High +corr' },
                      { color: '#a5b4fc', label: 'Moderate +' },
                ...
                <div className="bg-white border border-gray-100 rounded-xl shadow-sm p-5 space-y-4">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex flex-col gap-1 text-right flex-shrink-0 ml-4">
                      {[
                        ...
                        { color: 'bg-[#6366f1]', label: 'Efficient frontier' },
                  ...
                  <ResponsiveContainer width="100%" height={320}>
                    <ScatterChart margin={{ top: 10, right: 20, bottom: 20, left: 10 }}>
                      ...
                      {/* Efficient frontier */}
                      <Scatter name="Frontier" data={mvoResult.frontier} fill="#6366f1" opacity={0.7} />
                      {/* Max Sharpe */}
                        ...
                        {result.audit.map((row, i) => (
                          <tr key={i} className="border-t border-gray-100 hover:bg-gray-50 transition-colors">
                            ...
                            <td className="px-5 py-2.5">
                              <span
                                className={clsx('text-xs font-mono px-2 py-0.5 rounded-full', row.type === 'Initial' ? 'bg-emerald-100 text-emerald-700' : '')}
                                style={row.type !== 'Initial' ? { background: '#eef2ff', color: '#6366f1', border: '1px solid #c7d2fe' } : {}}
                              >
              ...
              <div className="bg-white border border-gray-100 rounded-xl shadow-sm p-5">
                <div className="flex items-center justify-between mb-4">
                  <p className="text-sm font-bold text-gray-900 flex items-center gap-2">
                    <RefreshCw className={clsx('w-4 h-4', genAI && 'animate-spin')} style={{ color: '#6366f1' }} />
                    Portfolio Strategy AI Commentary
                  </p>
                  {genAI && <span className="text-xs animate-pulse-soft uppercase" style={{ color: '#6366f1' }}>Analyzing...</span>}
                </div>
                {commentary ? (
